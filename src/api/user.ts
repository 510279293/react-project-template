...
export const userInfo = (params?: any) => request.post(`${APIPREFIX}/getCurrentUserInfo`, params)
...
// 用户手机号登录
export const phoneLogin = (params?: any) => request.post(`${APIPREFIX}/loginByPhoneCode`, params)
